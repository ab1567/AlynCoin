...
PROTOBUF_CONSTEXPR BlockProto::BlockProto(
  ...
  , /*decltype(_impl_.l2_transactions_)*/{}
  ...
  , /*decltype(_impl_.difficulty_bits_)*/0u} {}
...
const uint32_t TableStruct_block_5fprotos_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::alyncoin::BlockProto, _impl_.difficulty_bits_),
  ~0u,
  ~0u,
  ~0u,
  ~0u,
...
const char descriptor_table_protodef_block_5fprotos_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "root\030\024 \001(\t\022\023\n\013epoch_proof\030\025 \001(\014\022\027\n\017diffi"
  "culty_bits\030\026 \001(\rB\t\n\007_rewardb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_block_5fprotos_2eproto = {
    false, false, 635, descriptor_table_protodef_block_5fprotos_2eproto,
    "block_protos.proto",
...
BlockProto::BlockProto(const BlockProto& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.l2_transactions_){from._impl_.l2_transactions_}
    ...
    , decltype(_impl_.difficulty_bits_){}};
  ...
  _impl_.epoch_root_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.epoch_root_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_epoch_root().empty()) {
    _this->_impl_.epoch_root_.Set(from._internal_epoch_root(), 
      _this->GetArenaForAllocation());
  }
  _impl_.epoch_proof_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  ...
  ::memcpy(&_impl_.index_, &from._impl_.index_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.difficulty_bits_) -
    reinterpret_cast<char*>(&_impl_.index_)) + sizeof(_impl_.difficulty_bits_));
...
inline void BlockProto::SharedCtor(
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.l2_transactions_){arena}
    , decltype(_impl_.previous_hash_){}
    , decltype(_impl_.hash_){}
    , decltype(_impl_.miner_address_){}
    , decltype(_impl_.block_signature_){}
...
inline void BlockProto::SharedDtor() {
  ...
  _impl_.l2_transactions_.~RepeatedPtrField();
    ...
    switch (tag >> 3) {
      ...
      case 19:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 154)) {
          ...
          do {
            ptr += 2;
            ptr = ctx->ParseMessage(_internal_add_l2_transactions(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 20:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 162)) {
          auto str = _internal_mutable_epoch_root();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "alyncoin.BlockProto.epoch_root"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 21:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 170)) {
          auto str = _internal_mutable_epoch_proof();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 22:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 176)) {
          _impl_.difficulty_bits_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* BlockProto::_InternalSerialize(
  ...
  if (_internal_has_reward()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(18, this->_internal_reward(), target);
  }

  // repeated .alyncoin.TransactionProto l2_transactions = 19;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_l2_transactions_size()); i < n; i++) {
    const auto& repfield = this->_internal_l2_transactions(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(19, repfield, repfield.GetCachedSize(), target, stream);
  }

  // string epoch_root = 20;
  if (!this->_internal_epoch_root().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_epoch_root().data(), static_cast<int>(this->_internal_epoch_root().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "alyncoin.BlockProto.epoch_root");
    target = stream->WriteStringMaybeAliased(
        20, this->_internal_epoch_root(), target);
  }

  // bytes epoch_proof = 21;
  if (!this->_internal_epoch_proof().empty()) {
    target = stream->WriteBytesMaybeAliased(
        21, this->_internal_epoch_proof(), target);
  }

  // uint32 difficulty_bits = 22;
  if (this->_internal_difficulty_bits() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(22, this->_internal_difficulty_bits(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:alyncoin.BlockProto)
  ...
  // repeated .alyncoin.TransactionProto l2_transactions = 19;
  total_size += 2UL * this->_internal_l2_transactions_size();
  for (const auto& msg : this->_impl_.l2_transactions_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
  ...
  if (this->_internal_difficulty_bits() != 0) {
    total_size += 2 +
      ::_pbi::WireFormatLite::UInt32Size(
        this->_internal_difficulty_bits());
  }
...
void BlockProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.l2_transactions_.MergeFrom(from._impl_.l2_transactions_);
  if (!from._internal_previous_hash().empty()) {
  ...
  if (from._internal_difficulty_bits() != 0) {
    _this->_internal_set_difficulty_bits(from._internal_difficulty_bits());
  }
...
void BlockProto::InternalSwap(BlockProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.epoch_root_, lhs_arena,
      &other->_impl_.epoch_root_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(BlockProto, _impl_.difficulty_bits_)
      + sizeof(BlockProto::_impl_.difficulty_bits_)
